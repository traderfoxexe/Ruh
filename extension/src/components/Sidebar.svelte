  ...
  <div class="header">
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-2">
        ...
        <h1 class="text-xl font-bold text-gray-800">Eject</h1>
      </div>
    ...
    {:else if productAnalysis}
      ...
      <div class="section">
        <div class="harm-score">
          ...
          <div class="ml-4">
            <h3 class="text-lg font-semibold">{riskLevel}</h3>
...
<style lang="postcss">
  .sidebar {
    @apply fixed top-0 right-0 h-full w-[400px] bg-white shadow-2xl z-[999999] flex flex-col;
  }

  .header {
    @apply bg-gradient-to-r from-blue-600 to-blue-700 text-white p-4 shadow-md;
  }

  .close-btn {
    @apply text-white hover:bg-white/20 rounded-full w-8 h-8 flex items-center justify-center transition-colors text-xl font-bold;
  }
  ...
  .score-circle {
    @apply w-20 h-20 rounded-full flex flex-col items-center justify-center shadow-md;
  }
  ...
  .severity-badge {
    @apply px-2 py-1 rounded text-xs font-medium uppercase shrink-0;
  }
